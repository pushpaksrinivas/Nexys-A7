...
set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports { carry }]; #IO_L5P_T0_D06_14 Sch=led16_b
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { zero }]; #IO_L11N_T1_SRCC_14 Sch=led17_r

set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { control[1] }]; #IO_L9P_T1_DQS_14 Sch=btnc
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { control[0] }]; #IO_L4N_T0_D05_14 Sch=btnu
